  ...
  const requestScreenCapturePermission = async () => {
    if (typeof chrome !== 'undefined') {
      return new Promise((resolve) => {
        chrome.desktopCapture.chooseDesktopMedia(['screen', 'window', 'camera'], (streamId) => {
          resolve(streamId);
        });
      });
    } else {
      console.error('This function requires a Chrome Extension context.');
      return null;
    }
  };
  ...
  return (
    <>
      <Routes>
        ...
        <Route
          path="/recording"
          element={<Recording stopRecording={stopRecording} pauseRecording={pauseRecording} resumeRecording={resumeRecording} recording={recording} formatTime={formatTime} cancelRecording={cancelRecording} />}
        />
